        ...
        <div class="box">
            <div class="user-main" v-if="user_info">
                <div class="left">
                    ...
                    <p>
                        <el-tooltip content="订阅地址会被更换，重置后，所有使用订阅地址的地方都要进行替换" placement="right">
                            <el-button type="primary" @click="change_sub_key()" round>更换订阅地址</el-button>
                        </el-tooltip>
                    </p>
                    <p>
                        <el-tooltip content="订阅地址不会更换，重置后，所有使用订阅地址的客户端都需要更新订阅才能使用" placement="right">
                            <el-button type="primary" @click="change_uuid()" round>重置代理密码</el-button>
                        </el-tooltip>
                    </p>
                    <p>
                        <el-tooltip content="Wireguard专属密钥，重置后，需要更改配置文件的私钥，或者重新复制配置文件" placement="right">
                            <el-button type="primary" @click="change_wireguard_pri_key()"
                                round>重置Wireguard密码</el-button>
                        </el-tooltip>
                    </p>
                ...
                <div class="right">
                    <h3>一键导入</h3>
                    <p>
                        <a :href='encodeURI("shadowrocket://add/sub://" + btoa(user_info.sub_address[0] + "&type=shadowrocket") + "?remark=布吉岛")'
                            target="_blank">
                    ...
                    <p>
                        <a :href='encodeURI("sing-box://import-remote-profile?url=" + encodeURI(user_info.sub_address[0] + "&type=singbox") + "#布吉岛")'
                            target="_blank">
                            <el-button type="primary" round>
                                一键导入sing-box
                            </el-button>
                    ...
                    <p>
                        <a :href='encodeURI("sing-box://import-remote-profile?url=" + encodeURI(user_info.sub_address[0] + "&type=hidiffy") + "#布吉岛")'
                            target="_blank">
                            <el-button type="primary" round>
                                一键导入hidiffy
                            </el-button>
                    ...
                    <p>
                        <a :href='encodeURI("clash://install-config?url=" + encodeURI(user_info.sub_address[0] as string) + "&name=布吉岛")'
                            target="_blank">
