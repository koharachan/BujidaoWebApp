    ...
    <ol>
        <li>
            ...
            <div class="flex-row-wrap">
                <div>
                    <p>
                        1.1、在<span @click="go_to_files('/v2rayN')">岛岛</span>或者<span
                            @click="go_to_git">Github</span>官网下载后解压
                    </p>
