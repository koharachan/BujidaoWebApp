...
import { checkLoginKey, loginWithTelegram, loginWithEmail, loginWithEmailPasswd } from '@/utils/user'
        ...
        <div class="login-card">
            ...
            <div>
                <component :is="'script'" async src="https://telegram.org/js/telegram-widget.js?22"
                    :data-telegram-login="bot_id" data-size="large" data-onauth="window.onTelegramAuth(user)">
                </component>
            </div>
        </div>
    </div>
...
.c_h {
    ...
    font-family: -apple-system, system-ui, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu,
