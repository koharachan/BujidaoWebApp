            ...
            <div class="user-main" v-if="user_info">
                ...
                <div>
                    <div style="display:contents" v-for="item in invite_links" :key="item">
                        ...
                        <p class="hand" @click="touchCopy(item.invite_link)">邀请链接：
                            {{
                                item.invite_link
                            }}
                            <br />
                ...
                <el-dialog v-model="show_traffic_history" center :width="width < 800 ? '200%' : '90%'"
                    style="height:80vh" destroy-on-close align-center class="th">
                    <TrafficHistory />
                </el-dialog>
            </div>
        </div>
